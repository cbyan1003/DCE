...
PATHS.add_argument('--wandb_project', type=str, default="")
PATHS.add_argument('--wandb_entity', type=str, default="")
PATHS.add_argument('--wandb_tags', type=json.loads, default='')
PATHS.add_argument('--wandb_dir', type=str, default="")
PATHS.add_argument('--experiments_dir', type=str, default="")

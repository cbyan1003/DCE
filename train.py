...
DATASET.add_argument('--RGBD_3D_ROOT', type=str, default='/home/ycb/3DMatch/dataset/')     #need rewrite
DATASET.add_argument('--SCANNET_ROOT', type=str, default='/home/ycb/Scannet_dataset/v1')
...
DATASET.add_argument('--num_workers', type=int, default= 20)
...
ALIGN.add_argument('--num_correspodances', type=int, default=100)
...
SYSTEM.add_argument('--NUM_WORKERS', type=int, default=12)
...
EXPERIMENT.add_argument('--EXPname', type=str, default="0614")
...
PATHS.add_argument('--logging_method', type=str, default="wandb")
PATHS.add_argument('--wandb_dry_run', type=bool, default=False)
PATHS.add_argument('--wandb_project', type=str, default="PointBOBO")
PATHS.add_argument('--wandb_entity', type=str, default="cbyan103")
PATHS.add_argument('--wandb_tags', type=json.loads, default='["test"]')
PATHS.add_argument('--wandb_dir', type=str, default="/home/ycb/PointMBF/wandb_dir")
PATHS.add_argument('--experiments_dir', type=str, default="/home/ycb/PointMBF/experiments_dir")
...
SD = add_argument_group('Stable Diffusion')
SD.add_argument('--use_original', type=bool, default=False)
SD.add_argument('--seed', type=int, default=-1)
SD.add_argument('--basic', type=str, default='./models/sd_model/models')
SD.add_argument('--yaml', type=str, default='control_v11f1p_sd15_depth.yaml')
SD.add_argument('--sd_ckpt', type=str, default='v1-5-pruned.ckpt')
SD.add_argument('--cn_ckpt', type=str, default='control_v11f1p_sd15_depth_ft.pth')
SD.add_argument('--t', type=int, default=150)
